...
export default (config) => {
    ...
    return connect(TemplateCommon.MapStateToProps(pageConfig.ModelsConfig, pageConfig.ActionNames, config.ExpandMapStateToProps), StaticIndex.MapDispatchToProps)(RootPage(ConnectAction("EntityEdit", EntityEdit, pageConfig.ActionOptions)));
}