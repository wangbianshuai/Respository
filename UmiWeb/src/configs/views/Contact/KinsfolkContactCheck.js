...
function GetRightButtonProperties() {
    ...
    { ...GetButton("SaveKinsfolkContactCheck", "保存", "primary"), EventActionName: "SaveKinsfolkContactCheck", Style: { marginRight: 36, width: 84 } }]
}
...
function GetProperties() {
    return [
        ...
        GetTextArea("Question1", "问题二", 7, 1, "：单位名称、单位地址", "请输入备注"),
        GetTextArea("Question1", "问题三", 8, 1, "：主要申请人住宅地址", "请输入备注"),
        GetTextArea("Question1", "问题四", 9, 1, "：主要申请人资产情况", "请输入备注"),
        GetTextArea("Question1", "问题五", 10, 1, "：主要申请人负债情况", "请输入备注"),
        GetTextArea("Question1", "问题六", 11, 1, "：主要申请人其他联系方式", "请输入备注"),
        GetTextArea("Question1", "问题七", 12, 1, "：主要申请人其他公司", "请输入备注"),
        GetTextArea("Question1", "问题八", 13, 1, "：主要申请人投资偏好/不良嗜好/是否购买保险以及家庭成员健康情况", "请输入备注"),
        GetTextArea("Question1", "问题九", 14, 1, "：主要申请人婚姻状况、子女情况", "请输入备注"),
        GetTextArea("Question1", "问题十", 15, 1, "：其他情况", "请输入备注")
    ]
}
