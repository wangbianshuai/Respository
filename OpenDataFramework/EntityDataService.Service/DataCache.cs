...
namespace EntityDataService.Service
{
    public class DataCache
    {
        ...
        public static ConcurrentDictionary<string, string> JsList = new ConcurrentDictionary<string, string>();
        public static ConcurrentDictionary<string, string> CssList = new ConcurrentDictionary<string, string>();
