...
namespace EntityDataService.Data
{
    public class Query : IQuery
    {
        ...
        {
            _JoinSql = DataCommon.GetJoinStatement(joinList);
            return this;
        }
        ...
        {
            _WhereSql = DataCommon.GetWhereStatement(whereList);
            _ParameterList = parameterList;
            return this;
        }
        ...
        {
            _FieldSql = string.Concat(" ", DataCommon.GetFields(fieldList), " ");
            return this;
        }
        ...
        {
            _OrderBySql = string.Concat(" ", DataCommon.GetOrderByStatement(orderByList), " ");
            return this;
        }

        public IQuery GroupBy(List<string> groupByList)
        {
            _GroupBySql = string.Concat(" ", DataCommon.GetGroupByFields(groupByList), " ");
            return this;
        }
