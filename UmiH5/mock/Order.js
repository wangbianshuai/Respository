...
export default {
    'POST /RiskControlApproval/workOrder/pool/queryWorkOrder': GetOrderList(),
    'POST /RiskControlApproval/getorderlist': GetOrderList(),
    'POST /RiskControlApproval/getorderstatuslogs': GetOrderStatusLogs(),
    "POST /RiskControlApproval/workOrder/pool/GetRoleUser": GeRoleUser(),
    "POST /RiskControlApproval/getorderinfo": GetOrderInfo(),
    'POST /RiskControlApproval/saveorderinfo': SaveOrderInfo,
    'POST /RiskControlApproval/getorderdetail': GetOrderDetail(),
    'POST /RiskControlApproval/saveorderdetail': SaveOrderDetail,
    "POST /RiskControlApproval/SubmitOrderInfo": SubmitOrderInfo(),
    "POST /RiskControlApproval/SaveApprovalOrderDetail": SaveApprovalOrderDetail(),
    "POST /RiskControlApproval/GetCityList": GetCityList(),
    "POST /RiskControlApproval/GetOrderStatus": GetOrderStatus(),
    "POST /RiskControlApproval/GetPatchExitOrderInfo": GetPatchExitOrderInfo(),
    "POST /RiskControlApproval/GetExitOrderInfo": GetExitOrderInfo()
}
...
function GetOrderList() {
    return {
        respCode: 0,
        respMsg: "",
        data: [{ loanApplyId: "00001", mainLender: "测试公司1", lenderName: "张三", productType: "新商贷", loanSellerId: "李四", loanApplyTime: "2019-05-10", updateTime: "2019-05-10", workOrderState: "待初审" },
        { loanApplyId: "00002", mainLender: "测试公司2", lenderName: "张三", productType: "新商贷", loanSellerId: "李四", loanApplyTime: "2019-05-10", updateTime: "2019-05-10", workOrderState: "待初审" },
        { loanApplyId: "00003", mainLender: "测试公司3", lenderName: "张三", productType: "新商贷", loanSellerId: "李四", loanApplyTime: "2019-05-10", updateTime: "2019-05-10", workOrderState: "待初审" }]
    }
}
