...
class PlatformRateConfig extends BaseIndex {
    ...
    RateTypeValueChange(value) {
        ...
        const hideColNames = value === 1 ? ["ServiceRate", "FineRate"] : value === 2 ? ["ManageRate", "FineRate"] : ["ServiceRate", "ManageRate", "CollectionType", "CollectionMethod"];
...
function mapStateToProps(state, ownProps) {
    const props = StaticIndex.MapStateToProps(state, ownProps, {
        DataList: state.PlatformRateService.DataList,
