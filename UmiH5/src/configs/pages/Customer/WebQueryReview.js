import NetCheck from "../../entities/NetCheck";
import { GetButton, AssignProporties, CreateGuid, GetTextBox, GetSelect, GetRadio } from "../Common";
...
function GetQueryName() {
    const p = GetSelect("QueryName", "", GetQueryNameDataSource(), 2, 2, "BorrowerUser");
...
function GetQueryNameDataSource() {
    return [{ Value: "BorrowerUser", Text: "借款人" }, { Value: "Phone", Text: "手机号" }, { Value: "IdNumber", Text: "身份证号" }]
}
...
function GetOpinionRadio() {
    return {
        ...GetRadio("OpinionStatus", "意见", GetOpinionStatusDataSource(), 1, 1),
        IsFormItem: true,
        ColSpan: 24,
        IsButton: false,
        IsNullable: false,
