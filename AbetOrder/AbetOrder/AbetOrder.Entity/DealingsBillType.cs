...
{
    [TableProperty(Name = "t_d_DealingsBillType", PrimaryKey = "Id", NoSelectNames = "IsDelete")]
    public class DealingsBillType : EntityModel, IEntity
    {
        /// <summary> 
        /// 主键
        /// </summary> 
    ...
    [TableProperty(Name = "v_DealingsBillType", PrimaryKey = "Id", NoSelectNames = "IsDelete")]
    public class ViewDealingsBillType : BillType
    {
