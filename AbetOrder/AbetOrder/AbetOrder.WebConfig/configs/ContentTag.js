(function () {
    window.configs.ContentTag = {
        ...
        SelectNames: ["Id", "RowVersion", "Name", "ParameterNames", "Remark"],
        SearchNames: ["Name"],
        DataColumnNames: ["Name", "Remark", "ParameterNames"],
        EditNames: ["Name", "Remark", "ParameterNames", "WebApiUrl", "SqlStatement"],
