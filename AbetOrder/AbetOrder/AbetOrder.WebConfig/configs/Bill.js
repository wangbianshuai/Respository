(function () {
    window.configs.Bill = {
        ...
        SelectNames: ["Id", "RowVersion", "Amount2", "BillTypeName", "DataId", "CreateUser", "OrderName2", "IncomePaymentName", "BillStatusName", "BillUserName", "CreateUserName", "BillType", "BillDate", "Remark"],
        SearchNames: ["IncomePayment", "BillTypeId", "BillUser", "BillStatus", "StartDate", "EndDate", "Remark"],
    ...
    function GetProperties() {
        ...
        { Label: "备注", Name: "Remark", DataType: "string", Rows: 3, SearchProperty: { ColSpan: 5, X: 2, Y: 3 }, EditProperty: { ControlType: "TextArea" }, MaxLength: 200, IsNullable: true },
        { Label: "类型", Name: "BillTypeName" },
        { Label: "收支", Name: "IncomePaymentName" },
        { Label: "记账人", Name: "CreateUserName" },
        { Label: "订单", Name: "OrderName2", PropertyName: "DataId", IsToPage: true, PageUrl: "/OrderEdit?OrderId={DataId}" },
