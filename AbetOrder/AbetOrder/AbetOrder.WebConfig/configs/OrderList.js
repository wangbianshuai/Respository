(function () {
    ...
    function GetProperties() {
        return [
            ...
            { Label: "订单编号", Name: "OrderCode", IsOpenPage: true, IsAddToken: true, SearchProperty: { PropertyName: null }, PropertyName: "OrderId", PageUrl: "Order.aspx?Name=B17DC2B1-AF38-4C79-AAE3-3C784CAC6F98&Id={OrderId}", ColumnWidth: 100, DataType: "string", X: 2, Y: 1, ColSpan: 5, MaxLength: 50, IsNullable: true },
