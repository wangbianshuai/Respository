(function () {
    window.configs.OrderList = {
        ...
        DataColumnNames: ["OrderCode", "OrderDate", "DeliveryDate", "OrderStatusName", , "ActualAmount", "ProcessAmount2", "PaidDeposit", "ShouldPayBalance", "CreateUserName"],
    ...
    function GetProperties() {
        return [
            ...
            { Label: "订单编号", Name: "OrderCode", IsOpenPage: true, IsAddToken: false, SearchProperty: { PropertyName: null }, PropertyName: "OrderId", PageUrl: "Order.aspx?Name=B17DC2B1-AF38-4C79-AAE3-3C784CAC6F98&Id={OrderId}", DataType: "string", X: 3, Y: 1, ColSpan: 5, MaxLength: 50, IsNullable: true },
            { Label: "订单状态", Name: "OrderStatusName" },
            { Label: "客户", Name: "CustomerName", IsTooltip: true },
            { Label: "销售员", Name: "CreateUserName" },
            { Label: "门板花式", Name: "OrderName", DataType: "string", X: 3, Y: 2, ColSpan: 5, MaxLength: 50, IsNullable: true },
            { Label: "发货日期", Name: "DeliveryDate", IsDate: true },
            { Label: "订单金额", Name: "ActualAmount", IsCurrency: true, IsFixed2: false, FontColor: "#1890ff" },
            { Label: "加工费", Name: "ProcessAmount2", IsCurrency: true, IsFixed2: false, FontColor: "#1890ff" },
            { Label: "已收金额", Name: "PaidDeposit", IsNullable: false, IsCurrency: true, IsFixed2: false, FontColor: "#1890ff", Max: 100000000, Min: 1, Step: 1, Type: "TextBox", ControlType: "InputNumber", DataType: "decimal", MaxLength: 10 },
            { Label: "应收余额", Name: "ShouldPayBalance", IsCurrency: true, IsFixed2: false, FontColor: "#1890ff" },
