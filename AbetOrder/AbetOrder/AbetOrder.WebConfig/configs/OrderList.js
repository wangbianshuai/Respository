(function () {
    window.configs.OrderList = {
        ...
        SelectNames: ["OrderId", "RowVersion", "OrderCode", "OrderDate", "DeliveryDate", "CustomerName", "SaleUserName", "ActualAmount", "CostAmount2", "ProcessAmount2", "Profit", "PaidDeposit", "ShouldPayBalance", "OrderStatusName"],
    ...
    function GetProperties() {
        return [
            ...
            { Label: "订单编号", Name: "OrderCode", ColumnWidth: 100, DataType: "string", X: 2, Y: 1, ColSpan: 5, MaxLength: 50, IsNullable: true },
