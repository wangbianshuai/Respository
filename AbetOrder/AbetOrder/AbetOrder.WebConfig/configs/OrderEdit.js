(function () {
    window.configs.OrderEdit = {
        ...
        GetEntityDataUrl: "ViewOrder/GetOrder",
    ...
    function GetOrderPropeties() {
        ...
        { Label: "成本金额", Max: 100000000, Min: 0, Step: 1, IsReadonly: true, PlaceHolder: "只读，计算其值", Type: "TextBox", ControlType: "InputNumber", Name: "CostAmount", ColSpan: 11, LabelCol: 4, WrapperCol: 20, X: 8, Y: 1, DataType: "int", MaxLength: 10, IsNullable: true },
