...
export default class LeftRightLayout extends Component {
    ...
    GetHref(pageName, queryString) {
        ...
        if (href.indexOf(".html") < 0) {
            ...
            if (index > 0) href = href.substring(0, index) + ".html" + href.substring(index);
            else href = href + ".html";
        }
        return href;
    }
    ...
    GetMenuItem(m, pageName) {
        ...
        return <Menu.Item key={m.PageName}>
            {
                Common.IsEquals(m.PageName, pageName, true) && Common.IsEquals(this.CurrentPageName, pageName, true) ?
                    <div>
    ...
    render() {
        ...
        this.PageData.OrderStatus2 = this.OrderStatus;
