const DebtInfo = require("../../entities/DebtInfo");
...
module.exports = (actionTypes) => {
    ...
    return {
        Name: "DebtInfo",
        Type: "View",
        Properties: AssignProporties({ Name: "DebtInfo" }, [GetInfoView(), GetRightButtonView()])
    }
}
...
function GetRightButtonView() {
    return {
        ...
        IsDiv: true,
        Properties: AssignProporties({ Name: "DebtInfo" }, GetRightButtonProperties())
    }
}

function GetRightButtonProperties() {
    return [
        { ...GetButton("SaveDebtInfo", "保存", "primary"), Text2: "修改", EventActionName: "SaveDebtInfo", Style: { marginRight: 36, width: 84 } }]
}
...
function GetTextBox2(Name, Label, X, Y, ContorlType, PlaceHolder, MaxLength, IsNullable, addonAfter) {
    return {
        ...
        IsEdit: true,
        ReadRightName: "DebtInfoButtonView",
        Style: {
            display: "flex",
