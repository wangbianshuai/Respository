...
function GetRightButtonProperties() {
    ...
    { ...GetButton("SavePersonPropertyInfo", "保存", "primary"), Text2: "修改", IsDisabled: true, EventActionName: "SavePersonPropertyInfoEntityData", Style: { marginRight: 36, width: 84 } }]
}
...
function GetCarItemProperties() {
    return [
        { Name: "Title", Type: "SpanText", X: 1, Y: 1, ClassName: "SpanTitle" },
        { ...GetButton("DeleteCar", "删除", "", 1, 2), IsDisabled: true, RightNames: ["PersonPropertyInfoRightButtonView"], EventActionName: "DeleteCar", Style: { marginLeft: 20, marginBottom: 10 }, Icon: "delete" },
        GetTextBox2("CarNo", "车牌号码", 2, 1, "", "", 10, true),
        GetEditSelect("CarType", "车辆类型", Car.CarTypeDataSource, 2, 2, true, "请选择车辆类型"),
        GetTextBox2("CarUser", "车辆所有人", 2, 3, "", "", 100, true),
