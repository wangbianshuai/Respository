...
const { AssignProporties, GetTextBox, GetButton, CreateGuid, GetSelect } = require("../../Common");
...
module.exports = (actionTypes) => {
    ...
    return {
        ...
        Type: "View",
        Properties: AssignProporties({ Name: "PersonPropertyInfo" }, [GetInfoView(), GetRightButtonView()])
    }
}
...
function GetInfoView() {
    return {
        ...
        Properties: AssignProporties({ Name: "PersonPropertyInfo" }, [GetHouseProperties(), GetCarProperties(),
...
function GetCarProperties() {
    return {
        ...
        ColSpan: 24,
        Title: "车产信息",
        Properties: AssignProporties({ Name: "PersonPropertyInfo" }, [{
            Name: "CarItemView",
            Type: "RowsColsView",
            IsForm: true,
            LabelAlign: "left",
...
function GetRightButtonView() {
    return {
        ...
        IsDiv: true,
        Properties: AssignProporties({ Name: "PersonPropertyInfo" }, GetRightButtonProperties())
    }
}

function GetRightButtonProperties() {
    return [{ ...GetButton("SavePersonPropertyInfo", "保存", "primary"), Text2: "修改", EventActionName: "SavePersonPropertyInfoEntityData", Style: { marginRight: 36, width: 84 } }]
}
...
function GetCarItemProperties() {
    return [
        ...
        GetReadOnlySelect("CarType", "车辆类型", Car.CarTypeDataSource, 2, 2),
        GetReadOnlyTextBox("CarUser", "车辆所有人", 2, 3),
        GetReadOnlyTextBox("CarUserAddress", "车辆所有人住址", 3, 1),
        GetReadOnlySelect("CarUseNature", "使用性质", Car.CarUseNatureDataSource, 3, 2),
        GetReadOnlyTextBox("BrandModel", "品牌型号", 3, 3),
        GetReadOnlyTextBox("CarCode", "车辆识别代号", 4, 1),
        GetReadOnlyTextBox("CarAutoCode", "发动机号码", 4, 2),
        { ...GetReadOnlyTextBox("RegisterDate", "注册日期", 4, 3), IsDate: true },
        { ...GetReadOnlyTextBox("CardDate", "发证日期", 5, 1), IsDate: true }
    ]
}
