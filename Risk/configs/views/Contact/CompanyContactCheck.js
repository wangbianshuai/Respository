const CompanyContactCheck = require("../../entities/CompanyContactCheck");
...
module.exports = (actionTypes) => {
    ...
    return {
        ...
        Type: "View",
        Properties: AssignProporties({ Name: "CompanyContactCheck" }, [GetInfoView(), GetRightButtonView()])
    }
}
...
function GetInfoView() {
    return {
        ...
        Title: "单位相关信息核实",
        Style: { marginTop: 8 },
        Entity: CompanyContactCheck,
        EventActionName: "GetCompanyContactCheck",
...
function GetRightButtonView() {
    return {
        ...
        IsDiv: true,
        Properties: AssignProporties({ Name: "CompanyContactCheck" }, GetRightButtonProperties())
    }
}
...
function GetRightButtonProperties() {
    ...
    { ...GetButton("SaveCompanyContactCheck", "保存", "primary"), Text2: "修改", IsDisabled: true, EventActionName: "SaveCompanyContactCheck", Style: { marginRight: 36, width: 84 } }]
}
