...
module.exports = (actionTypes) => {
    ...
    return {
        Name: "PersonCredit",
        Type: "View",
        Properties: AssignProporties({ Name: "PersonCredit" }, [GetInfoView(), GetRightButtonView()])
    }
}
...
function GetInfoView() {
    return {
        ...
        DefaultEditData: { ViewName: "personalInfo" },
...
function GetRightButtonView() {
    return {
        ...
        IsDiv: true,
        Properties: AssignProporties({ Name: "PersonCredit" }, GetRightButtonProperties())
    }
}

function GetRightButtonProperties() {
    return [{ ...GetButton("SavePersonCredit", "保存", "primary"), Text2: "修改", IsDisabled: true, EventActionName: "SavePersonCredit", Style: { marginRight: 36, width: 84 } }]
}
