...
const { GetButton, AssignProporties, CreateGuid, GetRadio, GetTextBox, GetSelect, GetSelect2 } =require( "../../Common");
...
function GetDialogViews() {
    return [{
        ...
        Properties: AssignProporties(Order, [
            { ...GetRadio("HandlerType", "贷审会规则", GetHandlerTypeDataSource(), 1, 1, "0", 120), IsLoadValue: true, ColSpan: 19, IsFormItem: true },
            {
                ...GetSelect2("UserList", "审核成员", GetUserListDataSource(), 2, 1), ListName: "userList", IsLoadValue: true,
                ExpandSetDataList: "SetUserDataList", ValueName: "UserId", TextName: "UserName",
                PlaceHolder: "可输入关键字检索", AllowClear: true, IsSearch: true, ColSpan: 19, IsFormItem: true
            },
...
function GetDataListView() {
    return {
        ...
        Properties: AssignProporties({Name:"WaitingOrderList"}, [{
            Name: "UserName",
            Type: "SpanText"
        },
        {
...
function GetUserListDataSource() {
    return {
        ValueName: "UserId",
        TextName: "UserName",
        StateName: "RoleUserList",
        ServiceName: "UserService",
        ActionName: "GetRoleUserList",
        IsRefresh: true,
        Payload: { roleName: "终审贷审会" }
    }
}