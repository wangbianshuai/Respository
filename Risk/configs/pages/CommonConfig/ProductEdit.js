...
function GetProperties() {
    return [
        { IsUpdateReadOnly: true, ...GetEditSelect("ProductType", "产品大类", GetProductDataSource(), 1, 1, false, "请选择产品大类") },
        { IsUpdateReadOnly: true, ...GetTextBox2("ProductName", "产品名称", 2, 1, "", "请输入产品名称", 50, false) },
        { IsUpdateReadOnly: true, ...GetTextBox2("ProductCode", "产品代码", 3, 1, "", "请输入产品代码", 20, false) },
        GeLoanAmountView(),
        GetBackMethods(),
...
function GeLoanAmountView() {
    return {
        ...
        Properties: AssignProporties(Product, GetLoanAmountProperties())
    }
}
