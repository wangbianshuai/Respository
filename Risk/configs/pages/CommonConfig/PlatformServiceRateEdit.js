...
module.exports= {
    ...
    Properties: AssignProporties({Name:"PlatformServiceRateEdit"}, [GeEditView()])
}
...
function GetProperties() {
    return [
        ...
        GetTextBox3("ServiceRate", "信息服务费率", 2, 1, "float", "请输入信息服务费率", 6, false, "%", 0, 100),
...
function GetButtonView() {
    return {
        ...
        X: 6,
        Y: 1,
        Properties: AssignProporties({Name:"PlatformServiceRateEdit"}, GetButtonProperties())
    }
}
