...
import { Cache, EnvConfig } from "UtilsCommon";
    ...
    GetReducers() {
        ...
        this.ActionList.forEach(a => {
            ...
            obj[key] = (state, action) => {
                ...
                if (EnvConfig.IsServer && action.payload && action.payload.IsSuccess !== false) Cache.SetCache(this.namespace + "_" + a.ActionName, action.payload);
