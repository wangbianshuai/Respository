...
class UserLicense extends BaseIndex {
    constructor(props) {
        super(props);
    }
    ...
    static LoadData(ctx, app) {
        return BaseIndex.Dispatch(app._store.dispatch, "PageView", "GetCompanyUserLicense");
    }
...
function mapStateToProps(state, ownProps) {
    return {
        PageData: state.PageView.CompanyUserLicense
    };
}

export default connect(mapStateToProps, BaseIndex.MapDispatchToProps)(UserLicense);