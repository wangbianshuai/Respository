...
class Withdraw extends BaseIndex {
    ...
    GetCssList() {
        return ["/build/css/reset.css", "/build/mods/company/withdraw/_.css"];
    }

    GetJsList() {
        return ["/build/mods/company/withdraw/_.js"];
    }

    //服务器渲染加载数据
    static LoadData(ctx, app) {
        return BaseIndex.Dispatch(app._store.dispatch, "PageView", "GetCompanyWithdraw");
    }
                ...
                <div className="g-top">
                    <div className="g-top-con">
                        <div className="container-1200">
                            <a href="../../">首页</a> &gt; <a href="/usercenter/company/account.html">我的新新贷</a> &gt; <a href="javascript:void(0);">企业用户</a> &gt; <a href="javascript:void(0);">提现</a>
                        </div>
                    </div>
                </div>
                <div className="info-contaner clearfix">
                    <Menu MenuName1="userinfo" MenuName2="withdraw" MenuStatus={MenuStatus} IsCompany={true} />

                    <div className="g-right">
                        <div className="m-con-wrap">
                            <div className="m-con-hd clearfix">提现
                    <a className="withdrawRecord" href="/usercenter/company/dealDetail.html?tab=3">提现记录</a>
                            </div>
                            <div className="m-con-bd withdraw">

                                <div className="filed-user">
                                    <span className="threetxt">提现到</span>
                                    <p className="openbank" id="J_selectBank"><span>请选择银行卡</span><i onclick="window.location.href = '/usercenter/company/bundled.html'">选择&nbsp; &gt;</i></p>
                                </div>
...
function mapStateToProps(state, ownProps) {
    return {
        PageData: state.PageView.CompanyWithdraw
    };
}
