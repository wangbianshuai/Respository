...
class DealDetail extends BaseIndex {
    ...
    GetCssList() {
        return ["/build/css/reset.css", "/build/mods/company/dealDetail/_.css"];
    }

    GetJsList() {
        return ["/build/mods/company/dealDetail/_.js"];
    }

    //服务器渲染加载数据
    static LoadData(ctx, app) {
        return BaseIndex.Dispatch(app._store.dispatch, "PageView", "GetCompanyDealDetail");
    }
                ...
                <div className="g-top">
                    <div className="g-top-con">
                        <div className="container-1200">
                            <a href="http://www.xinxindai.com/">首页</a> &gt; <a href="/usercenter/company/account.html">我的新新贷</a> &gt;
                <a href="javascript:void(0);">企业用户</a> &gt;
                <a href="javascript:void(0);">交易明细</a>
                        </div>
                    </div>
                </div>
                <div className="info-contaner clearfix">
                    <Menu MenuName1="userinfo" MenuName2="dealDetail" MenuStatus={MenuStatus} IsCompany={true} />
...
function mapStateToProps(state, ownProps) {
    return {
        PageData: state.PageView.CompanyDealDetail
    };
}
