...
class UserCenterError extends BaseIndex {
    constructor(props) {
        super(props);
    }
    ...
    static LoadData(ctx, app) {
        return BaseIndex.Dispatch(app._store.dispatch, "PageView", "GetUserCenterError");
    }
...
function mapStateToProps(state, ownProps) {
    return {
        PageData: state.PageView.UserCenterError
    };
}

export default connect(mapStateToProps, BaseIndex.MapDispatchToProps)(UserCenterError);