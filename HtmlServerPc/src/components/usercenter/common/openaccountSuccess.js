...
class OpenaccountSuccess extends BaseIndex {
    constructor(props) {
        super(props);
    }
    ...
    static LoadData(ctx, app) {
        return BaseIndex.Dispatch(app._store.dispatch, "PageView", "GetOpenaccountSuccess");
    }
...
function mapStateToProps(state, ownProps) {
    return {
        PageData: state.PageView.OpenaccountSuccess
    };
}

export default connect(mapStateToProps, BaseIndex.MapDispatchToProps)(OpenaccountSuccess);