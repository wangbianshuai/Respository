            ...
            callbacks: function (data) {
                ...
                if ((data.code == "200000") || data.data) {
                    ...
                    $.each(data.data.list, function (i, item) {
                        ...
                        contentArray.push('<tr><td><a href="/detail/thirtytender.html" target="_blank"><span>' + item.name + '</span>');
                        contentArray.push('<span>' + $.fnDateToString(item.addDate, 'yyyy-MM-dd  HH:mm:ss') + '</span></a></td>');
                        if (item.floatApr && item.floatApr != 0) {
                            contentArray.push('<td>' + item.apr + '%+' + item.floatApr + '%</td>');
                        }else{
                            contentArray.push('<td>' + item.apr + '%</td>');
                        }
                        // contentArray.push('<td>' + item.joinApr + '%</td>');
                        contentArray.push('<td>' + side.numberFormat(item.account) + '元</td><td>' + item.period + item.periodUnit + '</td>');
                        contentArray.push('<td>' + side.numberFormat(item.interest) + '元</td>' + '<td><i class="' + classColor + '">' + item.newStatus + '</i></td>');
                        contentArray.push('<td class="main-color"><a href="/usercenter/bonds/thirtytender.html?join=' + item.joinId + '&thirtytenderStatus=' + thirtytenderStatus + '">查看详情</a></td>');
                        contentArray.push('<td class="main-color"><a href="/commpd/agree/XSCP30T_' + item.productId + '.html?productSign=XSCP30T&productJoinId=' + item.joinId + '">查看协议</a></td>');
                        ...
                        // if(item.newStatus == '可申请退出'){
                        //     $('#incomeTable').append('<tr>' + '<td>' + '<a href="/detail/thirtytender.html" target="_blank"><span>' + item.name + '</span>' + '<span>' + $.fnDateToString(item.addDate, 'yyyy-MM-dd  HH:mm:ss') + '</span></a></td>'
                        //
                        //     + '<td>' + item.joinApr + '%</td>' + '<td>' + side.numberFormat(item.account) + '元</td>' + '<td>' + item.period + item.periodUnit + '</td>'
                    ...
                    var html = contentArray.join("");
                    $('#incomeTable').append(html);
                } else {
                    $('#incomeTable').append("<tr class='no-record'><td colspan='9'><a href='/detail/thirtytender.html'>当前尚未加入，去看看！</a></td> </tr>")
                }
            },
