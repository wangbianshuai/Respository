...
export default class Index extends BaseIndex2 {
    constructor(props) {
        ...
        props.Property.SetVisible = (e) => this.SetVisible(e);
    }
    ...
    render() {
        ...
        return (
            <div id='J_calculatorTipToolTip' class='mui-calculator-tip-tooltip clearfix'>
                <div class='mui-calculator-tip-arrow mui-calculator-tip-arrowTop'><div class='mui-calculator-tip-arrowIn'></div></div>
                <div class='mui-calculator-tip-block'>{this.props.children}</div>
            </div>
        )
    }
}
