...
const RouterConfigs = [
    ...
    // r("consumption/consumptionDetail", "/detail/consumption/:bidCode.html"),
    // r("consumption/consumptionList", "/detail/consumptionList.html"),
    // r("detail/authorizStatus", "/detail/authorizStatus.html"),
    // r("detail/investFail", "/detail/investFail.html"),
    // r("detail/monthgold", "/detail/monthgold.html"),
    // r("detail/newtender", "/detail/newtender.html"),
    // r("detail/purchaseSuccess", "/detail/purchaseSuccess.html"),
    // r("detail/thirtytender", "/detail/thirtytender.html"),
    // r("usercenter/activity/coupon", "/usercenter/coupon.html"),
    ...
    // r("protocol/userlicenseAgree", "/detail/userProtocol.html", [], "./src/views/userLicense.html"),
