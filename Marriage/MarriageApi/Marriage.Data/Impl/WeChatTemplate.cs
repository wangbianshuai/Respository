...
{
    public class WeChatTemplate : EntityAccess, IWeChatTemplate
    {
        public WeChatTemplate()
        {
            this.EntityType = EntityType.GetEntityType<Entity.Data.WeChatTemplate>();
        }
        ...
        {
            (this.CurrentDataBase as ISqlDataBase).SqlBulkCopyInsert(GetDataTable(entityDataList), "t_WeChatTemplate");
        }
        ...
        DataTable GetDataTable(List<IEntityData> entityDataList)
        {
            ...
            dt.Columns.Add(new DataColumn("PrimaryIndustry", typeof(string)));
            dt.Columns.Add(new DataColumn("DeputyIndustry", typeof(string)));
            dt.Columns.Add(new DataColumn("Content", typeof(string)));
            dt.Columns.Add(new DataColumn("Example", typeof(string)));
