...
config.actionList.push(get("getAppMatchmakers", "ViewMatchmaker?$select=MatchmakerId,Name&$filter=Status eq 1 and IsAppMatchmaker eq 1&$orderby CreateDate", "getAppMatchmakers", "ViewMatchmaker"));
