...
function getMarriageManage() {
    ...
    menuList.push(addMenu("marriageSquareList", "相亲广场", false, "table", "/marriageManage/marriageSquareList"));
    menuList.push(addMenu("marriageSquareRecordList", "相亲广场记录", false, "table", "/marriageManage/marriageSquareRecordList"));
    ...
    menuList.push(addMenu("matchmakerFeeDetailList", "中介费明细", false, "table", "/marriageManage/matchmakerFeeDetailList"));
