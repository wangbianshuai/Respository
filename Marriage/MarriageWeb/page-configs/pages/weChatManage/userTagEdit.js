...
//weChatManage/userTagEdit 1400-1499
...
module.exports = {
    ...
    properties: assignProporties({ name: "userTagEdit" }, [getEditView()])
}
...
function getEditView() {
    return {
        ...
        properties: assignProporties(userTag, getProperties())
    }
}
...
function getButtonView() {
    return {
        ...
        x: 5,
        y: 1,
        properties: assignProporties({ name: "userTagEdit" }, getButtonProperties())
    }
}
...
function getEventActions() {
    return [{
        name: "backToLast",
        type: "page/toPage",
        pageUrl: "/weChatManage/userTagList",
        expandSetPageUrl: "expandSetPageUrl"
    },
    {
        name: "saveEntityData",
        type: "entityEdit/saveEntityData",
        editView: "userTagEdit2",
