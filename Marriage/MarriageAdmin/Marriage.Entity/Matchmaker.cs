...
{
    [TableProperty(Name = "t_Matchmaker", PrimaryKey = "MatchmakerId")]
    [RequestMethod(IsDelete = false)]
    public class Matchmaker : EntityModel, IEntity
    {
        /// <summary> 
        /// 主键
        /// </summary> 
    ...
    [TableProperty(Name = "v_Matchmaker", PrimaryKey = "MatchmakerId", NoSelectNames = "IsDelete")]
