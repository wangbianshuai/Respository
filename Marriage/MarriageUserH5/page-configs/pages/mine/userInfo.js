...
function getButtonView() {
  return {
    ...
    properties: [
      { ...getButton('save', '保存', 'primary', 1, 1), saveEntityDataActionType: dataActionTypes.updateUserInfo, className: 'button', eventActionName: 'updateUserInfo', rowClassName: "divRow4" },
    ]
  }
}
