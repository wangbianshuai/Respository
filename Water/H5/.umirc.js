...
export default {
  treeShaking: true,
	extraBabelPresets:["@babel/preset-react", "@babel/preset-env"],
	extraBabelPlugins:['@babel/transform-runtime', '@babel/plugin-transform-object-assign'],
  plugins: [
